...
class Login(object):
    def __init__(self,master):
        ...
        self.Title = Label(self.master, text=windowtitle).grid(row=0,column=0,columnspan=2)
        self.Username = Label(self.master, text="Username").grid(row=1,column=0)
        self.Password = Label(self.master, text="Password").grid(row=2,column=0)
